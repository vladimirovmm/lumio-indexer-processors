...
**Note for Labs folks**: Use the file in [internal-ops](https://github.com/aptos-labs/internal-ops/blob/main/infra/apps/lumio-indexer-processors/metadata) instead. See the README there.
